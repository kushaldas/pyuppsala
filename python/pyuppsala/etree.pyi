...
_KeyName = Union[str, QName]
_ReadKeyName = Union[str, QName, _QNameLike]
...
class _Element:
    ...
    # attributes
    def get(self, key: _ReadKeyName, default: Any = None) -> Any: ...
    def set(self, key: _KeyName, value: str) -> None: ...
    ...
    def fast_sum_int_attr(
        self, key: _ReadKeyName, tag: Optional[_TagName] = None
    ) -> int: ...
...
class _Attrib:
    def __getitem__(self, key: _ReadKeyName) -> str: ...
    def __setitem__(self, key: _KeyName, value: str) -> None: ...
    def __delitem__(self, key: _KeyName) -> None: ...
...
class _IterParseContext:
    @property
    def root(self) -> Optional[_Element]: ...
    def __iter__(self) -> Iterator[tuple[str, Any]]: ...
    def __next__(self) -> tuple[str, Any]: ...

def iterparse(
    source: Any,
    events: Iterable[str] = ("end",),
    parser: Optional[XMLParser] = None,
    tag: Optional[_TagName] = None,
) -> _IterParseContext: ...
