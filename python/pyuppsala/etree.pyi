...
class _ElementTree:
    ...
    def parse(self, source: Any, parser: Optional[XMLParser] = None) -> _Element: ...
    def write(
        self,
        file: Any,
    ...
    def iter(self, tag: Optional[str] = None) -> Iterator[_Element]: ...
    def xpath(
        self, path: str, namespaces: Optional[dict[str, str]] = None, **variables: Any
    ) -> Any: ...
...
def parse(source: Any, parser: Optional[XMLParser] = None) -> _ElementTree: ...
def tostring(
...
class XMLSchema:
    error_log: list[Any]
    def __init__(self, etree: Optional[_Element] = None, *, file: Any = None) -> None: ...
    def validate(self, tree: Union[_Element, _ElementTree]) -> bool: ...
    def assertValid(self, tree: Union[_Element, _ElementTree]) -> None: ...
    def assert_(self, tree: Union[_Element, _ElementTree]) -> None: ...
